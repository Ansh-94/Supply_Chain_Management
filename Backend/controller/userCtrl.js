...
const loginAdmin = asyncHandler(async (req, res) => {
  ...
  console.log("📋 Admin role in DB:", findAdmin.role);
  console.log("🔒 Password hash in DB:", findAdmin.password ? `Yes (${findAdmin.password.substring(0, 10)}...)` : "MISSING!");
  
  if (findAdmin.role !== "admin") {
    console.log("❌ Error: User role is not 'admin', got:", findAdmin.role);
    res.status(401);
  ...
  if (findAdmin && passwordMatch) {
    ...
    console.log("❌ Error: Invalid Credentials - Password mismatch or user check failed");
    res.status(401);
    throw new Error("Invalid Credentials");
  }
});
